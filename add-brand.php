...
if(isset($_POST['save'])){
	...
	$sql = "SELECT BrandName FROM brandlist WHERE BrandName = '{$BName}'";
	...
	if(mysqli_num_rows($result) > 0){
		...
		$sql1 = "INSERT INTO brandlist (CompanyID, BrandName, Address, LocationName, Status)
		VALUES('{$CompID}','{$BName}','{$Address}','{$LName}','{$Status}')";
